...
python 010-legislation-types.py > /ConnectedGovernment/Gitlab/010-legislation-types.csv
sed -i '/#browse/d' /ConnectedGovernment/Gitlab/010-legislation-types.csv
cat /ConnectedGovernment/Gitlab/010-legislation-types.csv 

rm -f /ConnectedGovernment/Gitlab/010-legislation-types
touch /ConnectedGovernment/Gitlab/010-legislation-types
cat /ConnectedGovernment/Gitlab/010-legislation-types.csv | while read line
do
   ...
   echo "ConnectedGovernment: $Current_legislation_type_name: Creating project"
